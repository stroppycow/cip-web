...
from .views import RecherchePosteNomenclaturePCS2020View, RechercheProfessionAutocompletionView, RechercheProfessionIDView, IndexationNomenclaturePCS2020View,  IndexationIndexProfessionPCS2020View, RechercheAppartenanceListeView
...
urlpatterns = [
    ...
    path('appartenance_liste/', RechercheAppartenanceListeView.as_view()),
